...
def init_medications():
    ...
    if c.fetchone()[0] == 0:
        elderly_meds = [
            ...
            ('Wytensin', 'Guanabenz', 'High blood pressure'),
            ('Methyldopa', 'Methyldopa', 'High blood pressure'),
            ('Cardene', 'Nicardipine', 'High blood pressure'),
            ('Nimotop', 'Nimodipine', 'Subarachnoid hemorrhage'),
            ('Baypress', 'Nitrendipine', 'High blood pressure'),
            ('Sular', 'Nisoldipine', 'High blood pressure'),
            ('Lotrel', 'Amlodipine/Benazepril', 'High blood pressure'),
            ('Lexxel', 'Enalapril/Felodipine', 'High blood pressure'),
            ('Tarka', 'Trandolapril/Verapamil', 'High blood pressure'),
            ('Tekamlo', 'Aliskiren/Amlodipine', 'High blood pressure'),
            ('Tekturna', 'Aliskiren', 'High blood pressure'),
            ('Valturna', 'Aliskiren/Valsartan', 'High blood pressure'),
            ('Amturnide', 'Aliskiren/Amlodipine/HCTZ', 'High blood pressure'),
            ('Tribenzor', 'Olmesartan/Amlodipine/HCTZ', 'High blood pressure'),
            ('Exforge', 'Amlodipine/Valsartan', 'High blood pressure'),
            ('Exforge HCT', 'Amlodipine/Valsartan/HCTZ', 'High blood pressure'),
            ('Twynsta', 'Telmisartan/Amlodipine', 'High blood pressure'),
            ('Azor', 'Amlodipine/Olmesartan', 'High blood pressure'),
            ('Edarbyclor', 'Azilsartan/Chlorthalidone', 'High blood pressure'),
            ('Edarbi', 'Azilsartan', 'High blood pressure'),
            ...
            ('Ranexa', 'Ranolazine', 'Chronic angina'),
            ('Verquvo', 'Vericiguat', 'Heart failure'),
            ('Farxiga', 'Dapagliflozin', 'Heart failure, diabetes'),
            ('Kerendia', 'Finerenone', 'Chronic kidney disease'),

            # More diabetes medications
            ('Janumet', 'Sitagliptin/Metformin', 'Type 2 diabetes'),
            ('Kombiglyze', 'Saxagliptin/Metformin', 'Type 2 diabetes'),
            ('Jentadueto', 'Linagliptin/Metformin', 'Type 2 diabetes'),
            ('Kazano', 'Alogliptin/Metformin', 'Type 2 diabetes'),
            ('Invokamet', 'Canagliflozin/Metformin', 'Type 2 diabetes'),
            ('Xigduo', 'Dapagliflozin/Metformin', 'Type 2 diabetes'),
            ('Synjardy', 'Empagliflozin/Metformin', 'Type 2 diabetes'),
            ('Segluromet', 'Ertugliflozin/Metformin', 'Type 2 diabetes'),
            ('Glyxambi', 'Empagliflozin/Linagliptin', 'Type 2 diabetes'),
            ('Trijardy', 'Empagliflozin/Linagliptin/Metformin', 'Type 2 diabetes'),
            ('Qtern', 'Dapagliflozin/Saxagliptin', 'Type 2 diabetes'),
            ('Soliqua', 'Insulin glargine/Lixisenatide', 'Type 2 diabetes'),
            ('Xultophy', 'Insulin degludec/Liraglutide', 'Type 2 diabetes'),
            ('Basaglar', 'Insulin glargine', 'Diabetes'),
            ('Admelog', 'Insulin lispro', 'Diabetes'),
            ('Lyumjev', 'Insulin lispro', 'Diabetes'),
            ('Semglee', 'Insulin glargine', 'Diabetes'),
            ('Rezvoglar', 'Insulin glargine', 'Diabetes'),
            ('Mounjaro', 'Tirzepatide', 'Type 2 diabetes'),
            ('Rybelsus', 'Semaglutide', 'Type 2 diabetes'),
            ('Soliqua', 'Insulin glargine/Lixisenatide', 'Type 2 diabetes'),
            ('Insulin NPH', 'NPH insulin', 'Diabetes'),
            ('Insulin Regular', 'Regular insulin', 'Diabetes'),
            ('70/30 Insulin', '70/30 insulin mix', 'Diabetes'),
            ('75/25 Insulin', '75/25 insulin mix', 'Diabetes'),
            ('Novomix', 'Insulin aspart mix', 'Diabetes'),
            ('Humalog Mix', 'Insulin lispro mix', 'Diabetes'),

            # Additional bone health medications
            ('Miacalcin', 'Calcitonin nasal spray', 'Osteoporosis'),
            ('Fortical', 'Calcitonin nasal spray', 'Osteoporosis'),
            ('Didronel', 'Etidronate', 'Osteoporosis'),
            ('Skelid', 'Tiludronate', 'Paget\'s disease'),
            ('Aredia', 'Pamidronate', 'Osteoporosis'),
            ('Zometa', 'Zoledronic acid', 'Bone metastases'),
            ('Bonefos', 'Clodronate', 'Bone disease'),
            ('Ostac', 'Clodronate', 'Osteoporosis'),
            ('Calcimar', 'Calcitonin', 'Osteoporosis'),
            ('Cibacalcin', 'Calcitonin', 'Hypercalcemia'),
            ('Strontium ranelate', 'Strontium ranelate', 'Osteoporosis'),
            ('Vitamin K2', 'Menaquinone', 'Bone health'),
            ('Calcitriol', 'Calcitriol', 'Bone disease, kidney disease'),
            ('Rocaltrol', 'Calcitriol', 'Bone disease'),
            ('Paricalcitol', 'Paricalcitol', 'Secondary hyperparathyroidism'),
            ('Zemplar', 'Paricalcitol', 'Kidney disease'),
            ('Doxercalciferol', 'Doxercalciferol', 'Secondary hyperparathyroidism'),
            ('Hectorol', 'Doxercalciferol', 'Kidney disease'),
            ('Cinacalcet', 'Cinacalcet', 'Hyperparathyroidism'),
            ('Sensipar', 'Cinacalcet', 'Secondary hyperparathyroidism'),

            # Extended pain and inflammation medications
            ('Diclofenac gel', 'Diclofenac topical', 'Arthritis pain'),
            ('Voltaren gel', 'Diclofenac topical', 'Osteoarthritis'),
            ('Pennsaid', 'Diclofenac topical', 'Knee osteoarthritis'),
            ('Flector patch', 'Diclofenac patch', 'Acute pain'),
            ('Lidoderm', 'Lidocaine patch', 'Postherpetic neuralgia'),
            ('Ztlido', 'Lidocaine patch', 'Localized pain'),
            ('Aspercreme', 'Trolamine salicylate', 'Muscle pain'),
            ('Bengay', 'Methyl salicylate/Menthol', 'Muscle pain'),
            ('Icy Hot', 'Methyl salicylate/Menthol', 'Muscle pain'),
            ('Zostrix', 'Capsaicin', 'Neuropathic pain'),
            ('Qutenza', 'Capsaicin patch', 'Neuropathic pain'),
            ('Aspercreme with Lidocaine', 'Trolamine salicylate/Lidocaine', 'Arthritis pain'),
            ('Salonpas', 'Methyl salicylate/Menthol', 'Muscle pain'),
            ('ThermaCare', 'Heat therapy', 'Muscle pain'),
            ('Blue-Emu', 'Emu oil', 'Muscle pain'),
            ('Topricin', 'Homeopathic', 'Pain relief'),
            ('Arnica', 'Arnica montana', 'Bruising, pain'),
            ('Traumeel', 'Homeopathic combination', 'Inflammation'),
            ('Zeel', 'Homeopathic combination', 'Arthritis'),
            ('Heel BHI', 'Homeopathic combination', 'Various conditions'),

            # More mental health medications
            ('Abilify', 'Aripiprazole', 'Depression, bipolar, schizophrenia'),
            ('Rexulti', 'Brexpiprazole', 'Depression, schizophrenia'),
            ('Vraylar', 'Cariprazine', 'Bipolar, schizophrenia'),
            ('Latuda', 'Lurasidone', 'Bipolar depression, schizophrenia'),
            ('Geodon', 'Ziprasidone', 'Bipolar, schizophrenia'),
            ('Invega', 'Paliperidone', 'Schizophrenia'),
            ('Fanapt', 'Iloperidone', 'Schizophrenia'),
            ('Saphris', 'Asenapine', 'Bipolar, schizophrenia'),
            ('Clozaril', 'Clozapine', 'Treatment-resistant schizophrenia'),
            ('FazaClo', 'Clozapine', 'Schizophrenia'),
            ('Versacloz', 'Clozapine', 'Schizophrenia'),
            ('Loxitane', 'Loxapine', 'Schizophrenia'),
            ('Moban', 'Molindone', 'Schizophrenia'),
            ('Orap', 'Pimozide', 'Tourette syndrome'),
            ('Inapsine', 'Droperidol', 'Nausea, agitation'),
            ('Compazine', 'Prochlorperazine', 'Nausea, psychosis'),
            ('Sparine', 'Promazine', 'Psychosis'),
            ('Vesprin', 'Triflupromazine', 'Psychosis'),
            ('Serentil', 'Mesoridazine', 'Schizophrenia'),
            ('Etrafon', 'Perphenazine/Amitriptyline', 'Depression with anxiety'),

            # Extended antidepressants
            ('Luvox', 'Fluvoxamine', 'OCD, depression'),
            ('Luvox CR', 'Fluvoxamine ER', 'OCD, social anxiety'),
            ('Viibryd', 'Vilazodone', 'Depression'),
            ('Trintellix', 'Vortioxetine', 'Depression'),
            ('Brintellix', 'Vortioxetine', 'Depression'),
            ('Fetzima', 'Levomilnacipran', 'Depression'),
            ('Savella', 'Milnacipran', 'Fibromyalgia'),
            ('Forfivo', 'Bupropion', 'Depression'),
            ('Aplenzin', 'Bupropion', 'Depression'),
            ('Contrave', 'Naltrexone/Bupropion', 'Weight management'),
            ('Surmontil', 'Trimipramine', 'Depression'),
            ('Ascendin', 'Amoxapine', 'Depression'),
            ('Ludiomil', 'Maprotiline', 'Depression'),
            ('Asendin', 'Amoxapine', 'Depression'),
            ('Tofranil', 'Imipramine', 'Depression'),
            ('Tofranil-PM', 'Imipramine pamoate', 'Depression'),
            ('Janimine', 'Imipramine', 'Depression'),
            ('Norpramin', 'Desipramine', 'Depression'),
            ('Pertofrane', 'Desipramine', 'Depression'),
            ('Adapin', 'Doxepin', 'Depression'),
            ('Zonalon', 'Doxepin topical', 'Eczema'),
            ('Prudoxin', 'Doxepin topical', 'Eczema'),

            # More anxiety and sleep medications
            ('Buspar', 'Buspirone', 'Anxiety'),
            ('Vanspar', 'Buspirone', 'Anxiety'),
            ('Wellbutrin', 'Bupropion', 'Depression'),
            ('Zyban', 'Bupropion', 'Smoking cessation'),
            ('Chantix', 'Varenicline', 'Smoking cessation'),
            ('Quitiapine', 'Quetiapine', 'Sleep, bipolar'),
            ('Dayvigo', 'Lemborexant', 'Insomnia'),
            ('Quviviq', 'Daridorexant', 'Insomnia'),
            ('Hetlioz', 'Tasimelteon', 'Sleep disorders'),
            ('Xyrem', 'Sodium oxybate', 'Narcolepsy'),
            ('Xywav', 'Sodium oxybate', 'Narcolepsy'),
            ('Wakix', 'Pitolisant', 'Narcolepsy'),
            ('Sunosi', 'Solriamfetol', 'Narcolepsy'),
            ('Gabapentin', 'Gabapentin', 'Neuropathy, sleep'),
            ('Clonidine', 'Clonidine', 'ADHD, hypertension'),
            ('Kapvay', 'Clonidine ER', 'ADHD'),
            ('Intuniv', 'Guanfacine ER', 'ADHD'),
            ('Strattera', 'Atomoxetine', 'ADHD'),
            ('Qelbree', 'Viloxazine', 'ADHD'),

            # Additional thyroid medications
            ('Tirosint-SOL', 'Levothyroxine liquid', 'Hypothyroidism'),
            ('Levo-T', 'Levothyroxine', 'Hypothyroidism'),
            ('Synthroid', 'Levothyroxine', 'Hypothyroidism'),
            ('Levoxyl', 'Levothyroxine', 'Hypothyroidism'),
            ('Unithroid', 'Levothyroxine', 'Hypothyroidism'),
            ('Euthyrox', 'Levothyroxine', 'Hypothyroidism'),
            ('NP Thyroid', 'Thyroid desiccated', 'Hypothyroidism'),
            ('Np-Thyroid', 'Thyroid desiccated', 'Hypothyroidism'),
            ('Thyroid USP', 'Thyroid desiccated', 'Hypothyroidism'),
            ('Thyrar', 'Thyroid desiccated', 'Hypothyroidism'),
            ('Westhroid', 'Thyroid desiccated', 'Hypothyroidism'),
            ('Thyro-Tabs', 'Thyroid desiccated', 'Hypothyroidism'),
            ('Thyroid-S', 'Thyroid desiccated', 'Hypothyroidism'),
            ('Thyroid Extract', 'Thyroid desiccated', 'Hypothyroidism'),
            ('Thyroxine', 'Levothyroxine', 'Hypothyroidism'),
            ('T4', 'Levothyroxine', 'Hypothyroidism'),
            ('T3', 'Liothyronine', 'Hypothyroidism'),
            ('Thyro-Bloc', 'Potassium iodide', 'Thyroid protection'),
            ('SSKI', 'Potassium iodide', 'Thyroid conditions'),
            ('Lugol\'s solution', 'Iodine/Potassium iodide', 'Thyroid conditions'),
            ...
            ('Dexilant', 'Dexlansoprazole', 'GERD'),
            ('Voquezna', 'Vonoprazan', 'GERD'),
            ('Zegerid', 'Omeprazole/Sodium bicarbonate', 'GERD'),
            ('Mylanta', 'Aluminum/Magnesium hydroxide', 'Heartburn'),
            ('Mylicon', 'Simethicone', 'Gas'),
            ('Phazyme', 'Simethicone', 'Gas'),
            ('Beano', 'Alpha-galactosidase', 'Gas prevention'),
            ('Lactaid', 'Lactase', 'Lactose intolerance'),
            ('Align', 'Bifidobacterium', 'Digestive health'),
            ('Culturelle', 'Lactobacillus', 'Digestive health'),
            ('Florastor', 'Saccharomyces boulardii', 'Digestive health'),
            ('VSL#3', 'Probiotic combination', 'IBD'),
            ('Visbiome', 'Probiotic combination', 'IBS'),
            ('Alflorex', 'Bifidobacterium', 'IBS'),
            ('Symprove', 'Multi-strain probiotic', 'Digestive health'),
            ('Entyvio', 'Vedolizumab', 'IBD'),
            ('Stelara', 'Ustekinumab', 'IBD'),
            ('Humira', 'Adalimumab', 'IBD'),
            ('Remicade', 'Infliximab', 'IBD'),
            ('Cimzia', 'Certolizumab', 'IBD'),
            ('Simponi', 'Golimumab', 'IBD'),
            ('Xeljanz', 'Tofacitinib', 'IBD'),
            ('Rinvoq', 'Upadacitinib', 'IBD'),
            ('Zeposia', 'Ozanimod', 'IBD'),

            # More respiratory medications
            ('Anoro', 'Umeclidinium/Vilanterol', 'COPD'),
            ('Stiolto', 'Tiotropium/Olodaterol', 'COPD'),
            ('Utibron', 'Indacaterol/Glycopyrrolate', 'COPD'),
            ('Bevespi', 'Glycopyrrolate/Formoterol', 'COPD'),
            ('Trimbow', 'Beclomethasone/Formoterol/Glycopyrrolate', 'COPD'),
            ('Wixela', 'Fluticasone/Salmeterol', 'Asthma, COPD'),
            ('AirDuo', 'Fluticasone/Salmeterol', 'Asthma'),
            ('Combivent Respimat', 'Ipratropium/Albuterol', 'COPD'),
            ('Spiriva Handihaler', 'Tiotropium', 'COPD'),
            ('Spiriva Respimat', 'Tiotropium', 'COPD, Asthma'),
            ('Ipratropium bromide', 'Ipratropium', 'COPD'),
            ('Albuterol sulfate', 'Albuterol', 'Asthma, COPD'),
            ('Levalbuterol', 'Levalbuterol', 'Asthma, COPD'),
            ('Pirbuterol', 'Pirbuterol', 'Asthma'),
            ('Metaproterenol', 'Metaproterenol', 'Asthma, COPD'),
            ('Terbutaline', 'Terbutaline', 'Asthma'),
            ('Isoproterenol', 'Isoproterenol', 'Bronchospasm'),
            ('Epinephrine', 'Epinephrine', 'Anaphylaxis, asthma'),
            ('Racepinephrine', 'Racepinephrine', 'Bronchospasm'),
            ('Primatene Mist', 'Epinephrine', 'Asthma'),

            # Extended allergy medications
            ('Alavert', 'Loratadine', 'Allergies'),
            ('Tavist-1', 'Clemastine', 'Allergies'),
            ('Optimine', 'Azatadine', 'Allergies'),
            ('Semprex-D', 'Acrivastine/Pseudoephedrine', 'Allergies'),
            ('Rynatan', 'Azatadine/Pseudoephedrine', 'Allergies'),
            ('Trinalin', 'Azatadine/Pseudoephedrine', 'Allergies'),
            ('Allegra-D', 'Fexofenadine/Pseudoephedrine', 'Allergies'),
            ('Claritin-D', 'Loratadine/Pseudoephedrine', 'Allergies'),
            ('Zyrtec-D', 'Cetirizine/Pseudoephedrine', 'Allergies'),
            ('Xyzal-D', 'Levocetirizine/Pseudoephedrine', 'Allergies'),
            ('Sudafed', 'Pseudoephedrine', 'Nasal congestion'),
            ('Sudafed PE', 'Phenylephrine', 'Nasal congestion'),
            ('Afrin', 'Oxymetazoline', 'Nasal congestion'),
            ('Neo-Synephrine', 'Phenylephrine nasal', 'Nasal congestion'),
            ('Dristan', 'Oxymetazoline', 'Nasal congestion'),
            ('Vicks Sinex', 'Oxymetazoline', 'Nasal congestion'),
            ('Privine', 'Naphazoline', 'Nasal congestion'),
            ('Otrivin', 'Xylometazoline', 'Nasal congestion'),
            ('Ayr', 'Saline', 'Nasal moisturizing'),
            ('Ocean', 'Saline', 'Nasal irrigation'),

            # Neurological medications expansion
            ('Namenda XR', 'Memantine ER', 'Alzheimer\'s disease'),
            ('Namzaric', 'Donepezil/Memantine', 'Alzheimer\'s disease'),
            ('Exelon Patch', 'Rivastigmine patch', 'Alzheimer\'s, Parkinson\'s dementia'),
            ('Razadyne ER', 'Galantamine ER', 'Alzheimer\'s disease'),
            ('Aduhelm', 'Aducanumab', 'Alzheimer\'s disease'),
            ('Leqembi', 'Lecanemab', 'Alzheimer\'s disease'),
            ('Rylaze', 'Asparaginase', 'Alzheimer\'s research'),
            ('Cognex', 'Tacrine', 'Alzheimer\'s disease'),
            ('Hydergine', 'Ergoloid mesylates', 'Dementia'),
            ('Cerebrolysin', 'Neuropeptides', 'Dementia'),
            ('Piracetam', 'Piracetam', 'Cognitive enhancement'),
            ('Modafinil', 'Modafinil', 'Narcolepsy, cognitive enhancement'),
            ('Armodafinil', 'Armodafinil', 'Narcolepsy'),
            ('Nuvigil', 'Armodafinil', 'Sleep disorders'),
            ('Provigil', 'Modafinil', 'Narcolepsy'),
            ('Ritalin', 'Methylphenidate', 'ADHD, narcolepsy'),
            ('Concerta', 'Methylphenidate ER', 'ADHD'),
            ('Metadate', 'Methylphenidate', 'ADHD'),
            ('Methylin', 'Methylphenidate', 'ADHD'),
            ('Daytrana', 'Methylphenidate patch', 'ADHD'),

            # Extended Parkinson\'s medications
            ('Rytary', 'Carbidopa/Levodopa ER', 'Parkinson\'s disease'),
            ('Duopa', 'Carbidopa/Levodopa gel', 'Parkinson\'s disease'),
            ('Inbrija', 'Levodopa inhalation', 'Parkinson\'s disease'),
            ('Stalevo', 'Carbidopa/Levodopa/Entacapone', 'Parkinson\'s disease'),
            ('Parcopa', 'Carbidopa/Levodopa ODT', 'Parkinson\'s disease'),
            ('Mirapex ER', 'Pramipexole ER', 'Parkinson\'s disease'),
            ('Requip XL', 'Ropinirole ER', 'Parkinson\'s disease'),
            ('Neupro', 'Rotigotine patch', 'Parkinson\'s disease'),
            ('Apokyn', 'Apomorphine', 'Parkinson\'s disease'),
            ('Kynmobi', 'Apomorphine sublingual', 'Parkinson\'s disease'),
            ('Nourianz', 'Istradefylline', 'Parkinson\'s disease'),
            ('Ongentys', 'Opicapone', 'Parkinson\'s disease'),
            ('Xadago', 'Safinamide', 'Parkinson\'s disease'),
            ('Zelapar ODT', 'Selegiline ODT', 'Parkinson\'s disease'),
            ('Emsam', 'Selegiline patch', 'Depression'),
            ('Parlodel', 'Bromocriptine', 'Parkinson\'s disease'),
            ('Cycloset', 'Bromocriptine', 'Diabetes'),
            ('Permax', 'Pergolide', 'Parkinson\'s disease'),
            ('Cabaser', 'Cabergoline', 'Parkinson\'s disease'),

            # More seizure medications
            ('Keppra XR', 'Levetiracetam ER', 'Seizures'),
            ('Spritam', 'Levetiracetam ODT', 'Seizures'),
            ('Elepsia', 'Levetiracetam', 'Seizures'),
            ('Roweepra', 'Levetiracetam', 'Seizures'),
            ('Briviact', 'Brivaracetam', 'Seizures'),
            ('Vimpat', 'Lacosamide', 'Seizures'),
            ('Fycompa', 'Perampanel', 'Seizures'),
            ('Aptiom', 'Eslicarbazepine', 'Seizures'),
            ('Oxtellar XR', 'Oxcarbazepine ER', 'Seizures'),
            ('Trileptal', 'Oxcarbazepine', 'Seizures'),
            ('Tegretol XR', 'Carbamazepine ER', 'Seizures'),
            ('Carbatrol', 'Carbamazepine ER', 'Seizures'),
            ('Epitol', 'Carbamazepine', 'Seizures'),
            ('Equetro', 'Carbamazepine ER', 'Bipolar disorder'),
            ('Lamictal XR', 'Lamotrigine ER', 'Seizures, bipolar'),
            ('Lamictal ODT', 'Lamotrigine ODT', 'Seizures'),
            ('Subvenite', 'Lamotrigine', 'Seizures'),
            ('Topamax', 'Topiramate', 'Seizures, migraine'),
            ('Trokendi XR', 'Topiramate ER', 'Seizures'),
            ('Qudexy XR', 'Topiramate ER', 'Seizures'),

            # Eye medications expansion
            ('Combigan', 'Brimonidine/Timolol', 'Glaucoma'),
            ('Cosopt', 'Dorzolamide/Timolol', 'Glaucoma'),
            ('Cosopt PF', 'Dorzolamide/Timolol PF', 'Glaucoma'),
            ('Simbrinza', 'Brinzolamide/Brimonidine', 'Glaucoma'),
            ('Rocklatan', 'Netarsudil/Latanoprost', 'Glaucoma'),
            ('Vyzulta', 'Latanoprostene bunod', 'Glaucoma'),
            ('Rhopressa', 'Netarsudil', 'Glaucoma'),
            ('Duotrav', 'Travoprost/Timolol', 'Glaucoma'),
            ('Ganfort', 'Bimatoprost/Timolol', 'Glaucoma'),
            ('Xalacom', 'Latanoprost/Timolol', 'Glaucoma'),
            ('Betagan', 'Levobunolol', 'Glaucoma'),
            ('Betoptic', 'Betaxolol', 'Glaucoma'),
            ('Ocupress', 'Carteolol', 'Glaucoma'),
            ('OptiPranolol', 'Metipranolol', 'Glaucoma'),
            ('Iopidine', 'Apraclonidine', 'Glaucoma'),
            ('Propine', 'Dipivefrin', 'Glaucoma'),
            ('Phospholine Iodide', 'Echothiophate', 'Glaucoma'),
            ('Humorsol', 'Demecarium', 'Glaucoma'),
            ('Pilopine HS', 'Pilocarpine gel', 'Glaucoma'),
            ('Isopto Carpine', 'Pilocarpine', 'Glaucoma'),

            # Additional vitamins and supplements
            ('B-Complex', 'B-vitamin complex', 'B vitamin deficiency'),
            ('Stress Formula', 'Multivitamin with stress formula', 'Stress support'),
            ('Senior Formula', 'Senior multivitamin', 'Nutritional support'),
            ('Women\'s Formula', 'Women\'s multivitamin', 'Women\'s health'),
            ('Men\'s Formula', 'Men\'s multivitamin', 'Men\'s health'),
            ('Prenatal vitamins', 'Prenatal multivitamin', 'Pregnancy support'),
            ('Folic acid', 'Folic acid', 'Folate deficiency'),
            ('B12 sublingual', 'Vitamin B12 sublingual', 'B12 deficiency'),
            ('Iron bisglycinate', 'Iron bisglycinate', 'Iron deficiency'),
            ('Ferrous fumarate', 'Ferrous fumarate', 'Iron deficiency'),
            ('Ferrous gluconate', 'Ferrous gluconate', 'Iron deficiency'),
            ('Carbonyl iron', 'Carbonyl iron', 'Iron deficiency'),
            ('Heme iron', 'Heme iron', 'Iron deficiency'),
            ('Calcium citrate', 'Calcium citrate', 'Bone health'),
            ('Calcium phosphate', 'Calcium phosphate', 'Bone health'),
            ('Magnesium citrate', 'Magnesium citrate', 'Magnesium deficiency'),
            ('Magnesium glycinate', 'Magnesium glycinate', 'Magnesium deficiency'),
            ('Magnesium sulfate', 'Magnesium sulfate', 'Magnesium deficiency'),
            ('Potassium citrate', 'Potassium citrate', 'Potassium deficiency'),
            ('Potassium gluconate', 'Potassium gluconate', 'Potassium deficiency'),

            # Hormones expansion
            ('Estradot', 'Estradiol patch', 'Menopause'),
            ('Evra', 'Estradiol/Norelgestromin patch', 'Hormone replacement'),
            ('Divigel', 'Estradiol gel', 'Menopause'),
            ('EstroGel', 'Estradiol gel', 'Menopause'),
            ('Elestrin', 'Estradiol gel', 'Menopause'),
            ('Estrasorb', 'Estradiol emulsion', 'Menopause'),
            ('Vagifem', 'Estradiol vaginal', 'Vaginal atrophy'),
            ('Estring', 'Estradiol ring', 'Vaginal atrophy'),
            ('Femring', 'Estradiol ring', 'Menopause'),
            ('Cenestin', 'Synthetic estrogens', 'Menopause'),
            ('Enjuvia', 'Synthetic estrogens', 'Menopause'),
            ('Estratest', 'Estrogen/Testosterone', 'Menopause'),
            ('Covaryx', 'Estrogen/Testosterone', 'Menopause'),
            ('Duavee', 'Estrogen/Bazedoxifene', 'Menopause'),
            ('Combipatch', 'Estradiol/Norethindrone patch', 'Menopause'),
            ('FemhRT', 'Estradiol/Norethindrone', 'Menopause'),
            ('Angeliq', 'Estradiol/Drospirenone', 'Menopause'),
            ('Mimvey', 'Estradiol/Norethindrone', 'Menopause'),
            ('Prefest', 'Estradiol/Norgestimate', 'Menopause'),
            ('Jinteli', 'Estradiol/Norethindrone', 'Menopause'),

            # Migraine medications expansion
            ('Ubrelvy', 'Ubrogepant', 'Migraine'),
            ('Nurtec', 'Rimegepant', 'Migraine'),
            ('Reyvow', 'Lasmiditan', 'Migraine'),
            ('Aimovig', 'Erenumab', 'Migraine prevention'),
            ('Emgality', 'Galcanezumab', 'Migraine prevention'),
            ('Ajovy', 'Fremanezumab', 'Migraine prevention'),
            ('Vyepti', 'Eptinezumab', 'Migraine prevention'),
            ('Qulipta', 'Atogepant', 'Migraine prevention'),
            ('Nuplazid', 'Pimavanserin', 'Parkinson\'s psychosis'),
            ('Onzetra', 'Sumatriptan nasal powder', 'Migraine'),
            ('Tosymra', 'Sumatriptan nasal spray', 'Migraine'),
            ('Zomig nasal', 'Zolmitriptan nasal', 'Migraine'),
            ('Maxalt-MLT', 'Rizatriptan ODT', 'Migraine'),
            ('Relpax', 'Eletriptan', 'Migraine'),
            ('Frova', 'Frovatriptan', 'Migraine'),
            ('Axert', 'Almotriptan', 'Migraine'),
            ('Amerge', 'Naratriptan', 'Migraine'),
            ('Sumavel', 'Sumatriptan autoinjector', 'Migraine'),
            ('Alsuma', 'Sumatriptan autoinjector', 'Migraine'),
            ('Zembrace', 'Sumatriptan autoinjector', 'Migraine'),

            # Additional antibiotics
            ('Keflex', 'Cephalexin', 'Bacterial infections'),
            ('Duricef', 'Cefadroxil', 'Bacterial infections'),
            ('Ceclor', 'Cefaclor', 'Bacterial infections'),
            ('Ceftin', 'Cefuroxime', 'Bacterial infections'),
            ('Vantin', 'Cefpodoxime', 'Bacterial infections'),
            ('Suprax', 'Cefixime', 'Bacterial infections'),
            ('Cedax', 'Ceftibuten', 'Bacterial infections'),
            ('Spectracef', 'Cefditoren', 'Bacterial infections'),
            ('Rocephin', 'Ceftriaxone', 'Bacterial infections'),
            ('Fortaz', 'Ceftazidime', 'Bacterial infections'),
            ('Claforan', 'Cefotaxime', 'Bacterial infections'),
            ('Zinacef', 'Cefuroxime', 'Bacterial infections'),
            ('Ancef', 'Cefazolin', 'Bacterial infections'),
            ('Kefzol', 'Cefazolin', 'Bacterial infections'),
            ('Maxipime', 'Cefepime', 'Bacterial infections'),
            ('Teflaro', 'Ceftaroline', 'MRSA infections'),
            ('Avycaz', 'Ceftazidime/Avibactam', 'Bacterial infections'),
            ('Zerbaxa', 'Ceftolozane/Tazobactam', 'Bacterial infections'),
            ('Carbavance', 'Meropenem/Vaborbactam', 'Bacterial infections'),
            ('Vabomere', 'Meropenem/Vaborbactam', 'Bacterial infections'),

            # More antifungal medications
            ('Vfend', 'Voriconazole', 'Fungal infections'),
            ('Noxafil', 'Posaconazole', 'Fungal infections'),
            ('Cresemba', 'Isavuconazole', 'Fungal infections'),
            ('Eraxis', 'Anidulafungin', 'Fungal infections'),
            ('Cancidas', 'Caspofungin', 'Fungal infections'),
            ('Mycamine', 'Micafungin', 'Fungal infections'),
            ('AmBisome', 'Amphotericin B liposomal', 'Fungal infections'),
            ('Abelcet', 'Amphotericin B lipid complex', 'Fungal infections'),
            ('Amphotec', 'Amphotericin B colloidal', 'Fungal infections'),
            ('Fungizone', 'Amphotericin B', 'Fungal infections'),
            ('Grifulvin', 'Griseofulvin', 'Fungal infections'),
            ('Fulvicin', 'Griseofulvin', 'Fungal infections'),
            ('Gris-PEG', 'Griseofulvin', 'Fungal infections'),
            ('Onmel', 'Itraconazole', 'Fungal infections'),
            ('Lamisil AT', 'Terbinafine topical', 'Athlete\'s foot'),
            ('Mentax', 'Butenafine', 'Fungal skin infections'),
            ('Spectazole', 'Econazole', 'Fungal skin infections'),
            ('Oxistat', 'Oxiconazole', 'Fungal skin infections'),
            ('Naftin', 'Naftifine', 'Fungal skin infections'),
            ('Loprox', 'Ciclopirox', 'Fungal skin infections'),

            # More antiviral medications
            ('Epivir', 'Lamivudine', 'HIV, Hepatitis B'),
            ('Ziagen', 'Abacavir', 'HIV'),
            ('Videx', 'Didanosine', 'HIV'),
            ('Zerit', 'Stavudine', 'HIV'),
            ('Hivid', 'Zalcitabine', 'HIV'),
            ('Retrovir', 'Zidovudine', 'HIV'),
            ('Combivir', 'Zidovudine/Lamivudine', 'HIV'),
            ('Trizivir', 'Zidovudine/Lamivudine/Abacavir', 'HIV'),
            ('Truvada', 'Tenofovir/Emtricitabine', 'HIV prevention'),
            ('Descovy', 'Tenofovir alafenamide/Emtricitabine', 'HIV'),
            ('Viread', 'Tenofovir', 'HIV, Hepatitis B'),
            ('Emtriva', 'Emtricitabine', 'HIV'),
            ('Sustiva', 'Efavirenz', 'HIV'),
            ('Atripla', 'Efavirenz/Tenofovir/Emtricitabine', 'HIV'),
            ('Complera', 'Rilpivirine/Tenofovir/Emtricitabine', 'HIV'),
            ('Stribild', 'Elvitegravir/Cobicistat/Tenofovir/Emtricitabine', 'HIV'),
            ('Genvoya', 'Elvitegravir/Cobicistat/Tenofovir alafenamide/Emtricitabine', 'HIV'),
            ('Odefsey', 'Rilpivirine/Tenofovir alafenamide/Emtricitabine', 'HIV'),
            ('Biktarvy', 'Bictegravir/Tenofovir alafenamide/Emtricitabine', 'HIV'),
            ('Dovato', 'Dolutegravir/Lamivudine', 'HIV'),

            # Skin and wound care expansion
            ('Aquaphor', 'Petrolatum', 'Skin protection'),
            ('Eucerin', 'Urea/Ceramides', 'Dry skin'),
            ('CeraVe', 'Ceramides/Hyaluronic acid', 'Skin care'),
            ('Cetaphil', 'Gentle cleanser', 'Sensitive skin'),
            ('Aveeno', 'Oatmeal', 'Sensitive skin'),
            ('Lubriderm', 'Mineral oil', 'Dry skin'),
            ('Neutrogena', 'Various formulations', 'Skin care'),
            ('Vaseline', 'Petrolatum', 'Skin protection'),
            ('A&D Ointment', 'Vitamins A&D', 'Diaper rash'),
            ('Desitin', 'Zinc oxide', 'Diaper rash'),
            ('Boudreaux\'s', 'Zinc oxide', 'Diaper rash'),
            ('Triple Paste', 'Zinc oxide', 'Diaper rash'),
            ('Calmoseptine', 'Zinc oxide/Calamine', 'Skin irritation'),
            ('Critic-Aid', 'Zinc oxide', 'Incontinence dermatitis'),
            ('Proshield', 'Dimethicone', 'Skin protection'),
            ('No-Sting', 'Barrier film', 'Skin protection'),
            ('Cavilon', 'Barrier film', 'Skin protection'),
            ('Skin Prep', 'Barrier wipe', 'Skin protection'),
            ('Marathon', 'Liquid bandage', 'Wound protection'),
            ('New-Skin', 'Liquid bandage', 'Minor cuts'),

            # Extended diabetes monitoring
            ('Glucose test strips', 'Glucose test strips', 'Blood sugar monitoring'),
            ('Lancets', 'Lancets', 'Blood glucose testing'),
            ('Alcohol swabs', 'Isopropyl alcohol', 'Skin preparation'),
            ('Ketone strips', 'Ketone test strips', 'Ketone monitoring'),
            ('Continuous glucose monitor', 'CGM sensor', 'Glucose monitoring'),
            ('Freestyle Libre', 'CGM sensor', 'Glucose monitoring'),
            ('Dexcom', 'CGM sensor', 'Glucose monitoring'),
            ('Medtronic CGM', 'CGM sensor', 'Glucose monitoring'),
            ('Insulin pen needles', 'Pen needles', 'Insulin injection'),
            ('Insulin syringes', 'Insulin syringes', 'Insulin injection'),
            ('Sharps container', 'Sharps disposal', 'Medical waste'),
            ('Glucose gel', 'Glucose', 'Hypoglycemia treatment'),
            ('Glucose tablets', 'Glucose', 'Hypoglycemia treatment'),
            ('GlucoShots', 'Glucose liquid', 'Hypoglycemia treatment'),
            ('Insta-Glucose', 'Glucose gel', 'Hypoglycemia treatment'),
            ('BD Ultra-Fine', 'Insulin pen needles', 'Insulin delivery'),
            ('Novofine', 'Insulin pen needles', 'Insulin delivery'),
            ('Nano needles', 'Ultra-short needles', 'Insulin delivery'),
            ('Safety needles', 'Safety insulin needles', 'Insulin delivery'),
            ('Insulin cooling case', 'Insulin storage', 'Medication storage'),

            # Additional blood pressure medications
            ('Altace', 'Ramipril', 'High blood pressure'),
            ('Vasotec', 'Enalapril', 'High blood pressure'),
            ('Capoten', 'Captopril', 'High blood pressure'),
            ('Monopril', 'Fosinopril', 'High blood pressure'),
            ('Univasc', 'Moexipril', 'High blood pressure'),
            ('Aceon', 'Perindopril', 'High blood pressure'),
            ('Mavik', 'Trandolapril', 'High blood pressure'),
            ('Lotensin', 'Benazepril', 'High blood pressure'),
            ('Accupril', 'Quinapril', 'High blood pressure'),
            ('Prinivil', 'Lisinopril', 'High blood pressure'),
            ...
            # Muscle relaxants expansion
            ('Flexeril', 'Cyclobenzaprine', 'Muscle spasms'),
            ('Amrix', 'Cyclobenzaprine ER', 'Muscle spasms'),
            ('Fexmid', 'Cyclobenzaprine', 'Muscle spasms'),
            ('Zanaflex', 'Tizanidine', 'Muscle spasticity'),
            ('Lioresal', 'Baclofen', 'Muscle spasticity'),
            ('Gablofen', 'Baclofen', 'Spasticity'),
            ('Soma', 'Carisoprodol', 'Muscle pain'),
            ('Vanadom', 'Carisoprodol', 'Muscle spasms'),
            ('Robaxin', 'Methocarbamol', 'Muscle spasms'),
            ('Robaxin-750', 'Methocarbamol', 'Muscle pain'),
            ('Skelaxin', 'Metaxalone', 'Muscle spasms'),
            ('Paraflex', 'Chlorzoxazone', 'Muscle spasms'),
            ('Lorzone', 'Chlorzoxazone', 'Muscle pain'),
            ('Dantrium', 'Dantrolene', 'Muscle spasticity'),
            ('Revonto', 'Dantrolene', 'Malignant hyperthermia'),
            ('Ryanodex', 'Dantrolene', 'Malignant hyperthermia'),
            ('Norflex', 'Orphenadrine', 'Muscle spasms'),
            ('Banflex', 'Orphenadrine', 'Muscle pain'),
            ('Mio-Rel', 'Orphenadrine', 'Muscle spasms'),
            ('Quinine', 'Quinine', 'Leg cramps'),

            # Extended pain medications
            ('OxyContin', 'Oxycodone ER', 'Chronic pain'),
            ('Roxicodone', 'Oxycodone', 'Pain'),
            ('Oxyfast', 'Oxycodone liquid', 'Pain'),
            ('Percodan', 'Oxycodone/Aspirin', 'Pain'),
            ('Tylox', 'Oxycodone/Acetaminophen', 'Pain'),
            ('Endocet', 'Oxycodone/Acetaminophen', 'Pain'),
            ('Roxicet', 'Oxycodone/Acetaminophen', 'Pain'),
            ('MS Contin', 'Morphine ER', 'Chronic pain'),
            ('Kadian', 'Morphine ER', 'Chronic pain'),
            ('Avinza', 'Morphine ER', 'Chronic pain'),
            ('Morphine sulfate', 'Morphine', 'Severe pain'),
            ('MSIR', 'Morphine immediate release', 'Pain'),
            ('Oramorph', 'Morphine liquid', 'Pain'),
            ('Duragesic', 'Fentanyl patch', 'Chronic pain'),
            ('Actiq', 'Fentanyl lollipop', 'Breakthrough pain'),
            ('Fentora', 'Fentanyl buccal', 'Breakthrough pain'),
            ('Subsys', 'Fentanyl sublingual spray', 'Breakthrough pain'),
            ('Abstral', 'Fentanyl sublingual', 'Breakthrough pain'),
            ('Onsolis', 'Fentanyl buccal film', 'Breakthrough pain'),
            ('Lazanda', 'Fentanyl nasal spray', 'Breakthrough pain'),

            # Additional anti-inflammatory medications
            ('Medrol', 'Methylprednisolone', 'Inflammation'),
            ('Solu-Medrol', 'Methylprednisolone injection', 'Severe inflammation'),
            ('Depo-Medrol', 'Methylprednisolone injection', 'Joint inflammation'),
            ('Prednisolone', 'Prednisolone', 'Inflammation'),
            ('Prelone', 'Prednisolone liquid', 'Inflammation'),
            ('Pediapred', 'Prednisolone liquid', 'Pediatric inflammation'),
            ('Orapred', 'Prednisolone ODT', 'Inflammation'),
            ('Millipred', 'Prednisolone', 'Inflammation'),
            ('Veripred', 'Prednisolone', 'Inflammation'),
            ('Dexamethasone', 'Dexamethasone', 'Severe inflammation'),
            ('Decadron', 'Dexamethasone', 'Brain swelling'),
            ('DexPak', 'Dexamethasone taperpak', 'Inflammation'),
            ('Baycadron', 'Dexamethasone liquid', 'Inflammation'),
            ('Hydrocortisone', 'Hydrocortisone', 'Adrenal insufficiency'),
            ('Cortef', 'Hydrocortisone', 'Adrenal insufficiency'),
            ('Solu-Cortef', 'Hydrocortisone injection', 'Adrenal crisis'),
            ('Florinef', 'Fludrocortisone', 'Addison\'s disease'),
            ('Fludrocortisone', 'Fludrocortisone', 'Adrenal insufficiency'),
            ('Triamcinolone', 'Triamcinolone', 'Allergic conditions'),
            ('Kenalog', 'Triamcinolone injection', 'Joint inflammation'),

            # Kidney and urinary expansion
            ('Myrbetriq', 'Mirabegron', 'Overactive bladder'),
            ('Gemtesa', 'Vibegron', 'Overactive bladder'),
            ('Enablex', 'Darifenacin', 'Overactive bladder'),
            ('Sanctura', 'Trospium', 'Overactive bladder'),
            ('Sanctura XR', 'Trospium ER', 'Overactive bladder'),
            ('Oxytrol', 'Oxybutynin patch', 'Overactive bladder'),
            ('Gelnique', 'Oxybutynin gel', 'Overactive bladder'),
            ('Detrol LA', 'Tolterodine ER', 'Overactive bladder'),
            ('Vesicare LS', 'Solifenacin suspension', 'Overactive bladder'),
            ('Toviaz', 'Fesoterodine', 'Overactive bladder'),
            ('Botox', 'OnabotulinumtoxinA', 'Overactive bladder'),
            ('Proscar', 'Finasteride', 'Enlarged prostate'),
            ('Propecia', 'Finasteride', 'Hair loss'),
            ('Avodart', 'Dutasteride', 'Enlarged prostate'),
            ('Jalyn', 'Dutasteride/Tamsulosin', 'Enlarged prostate'),
            ('Combodart', 'Dutasteride/Tamsulosin', 'Enlarged prostate'),
            ('Doxazosin', 'Doxazosin', 'Enlarged prostate'),
            ('Cardura XL', 'Doxazosin ER', 'Enlarged prostate'),
            ('Terazosin', 'Terazosin', 'Enlarged prostate'),
            ('Prazosin', 'Prazosin', 'High blood pressure'),

            # Blood thinners expansion
            ('Heparin', 'Heparin', 'Blood clot treatment'),
            ('Lovenox', 'Enoxaparin', 'DVT prevention'),
            ('Fragmin', 'Dalteparin', 'DVT prevention'),
            ('Innohep', 'Tinzaparin', 'DVT treatment'),
            ('Arixtra', 'Fondaparinux', 'DVT prevention'),
            ('Angiomax', 'Bivalirudin', 'Anticoagulation'),
            ('Argatroban', 'Argatroban', 'Anticoagulation'),
            ('Refludan', 'Lepirudin', 'Anticoagulation'),
            ('Hirudin', 'Hirudin', 'Anticoagulation'),
            ('Persantine', 'Dipyridamole', 'Stroke prevention'),
            ('Aggrenox', 'Aspirin/Dipyridamole', 'Stroke prevention'),
            ('Ticlid', 'Ticlopidine', 'Stroke prevention'),
            ('Pletal', 'Cilostazol', 'Claudication'),
            ('Pentoxifylline', 'Pentoxifylline', 'Claudication'),
            ('Trental', 'Pentoxifylline', 'Circulation'),
            ('Effient', 'Prasugrel', 'Heart attack prevention'),
            ('Brilinta', 'Ticagrelor', 'Heart attack prevention'),
            ('Kengreal', 'Cangrelor', 'Cardiac procedures'),
            ('Integrilin', 'Eptifibatide', 'Cardiac procedures'),
            ('ReoPro', 'Abciximab', 'Cardiac procedures'),

            # More heart medications
            ('Cordarone', 'Amiodarone', 'Heart rhythm'),
            ('Pacerone', 'Amiodarone', 'Arrhythmias'),
            ('Nexterone', 'Amiodarone IV', 'Arrhythmias'),
            ('Sotalol', 'Sotalol', 'Heart rhythm'),
            ('Betapace', 'Sotalol', 'Arrhythmias'),
            ('Betapace AF', 'Sotalol', 'Atrial fibrillation'),
            ('Sorine', 'Sotalol', 'Heart rhythm'),
            ('Tikosyn', 'Dofetilide', 'Atrial fibrillation'),
            ('Multaq', 'Dronedarone', 'Atrial fibrillation'),
            ('Rythmol', 'Propafenone', 'Heart rhythm'),
            ('Rythmol SR', 'Propafenone SR', 'Arrhythmias'),
            ('Tambocor', 'Flecainide', 'Heart rhythm'),
            ('Norpace', 'Disopyramide', 'Heart rhythm'),
            ('Norpace CR', 'Disopyramide CR', 'Arrhythmias'),
            ('Quinidine', 'Quinidine', 'Heart rhythm'),
            ('Quinaglute', 'Quinidine', 'Arrhythmias'),
            ('Cardioquin', 'Quinidine', 'Heart rhythm'),
            ('Procainamide', 'Procainamide', 'Heart rhythm'),
            ('Pronestyl', 'Procainamide', 'Arrhythmias'),
            ('Procan', 'Procainamide', 'Heart rhythm'),

            # Additional diuretics
            ('Bumex', 'Bumetanide', 'Heart failure'),
            ('Demadex', 'Torsemide', 'Heart failure'),
            ('Edecrin', 'Ethacrynic acid', 'Fluid retention'),
            ('Microzide', 'Hydrochlorothiazide', 'High blood pressure'),
            ('Esidrix', 'Hydrochlorothiazide', 'Hypertension'),
            ('HydroDIURIL', 'Hydrochlorothiazide', 'Fluid retention'),
            ('Oretic', 'Hydrochlorothiazide', 'High blood pressure'),
            ('Chlorthalidone', 'Chlorthalidone', 'High blood pressure'),
            ('Hygroton', 'Chlorthalidone', 'Hypertension'),
            ('Thalitone', 'Chlorthalidone', 'High blood pressure'),
            ('Indapamide', 'Indapamide', 'High blood pressure'),
            ('Lozol', 'Indapamide', 'Hypertension'),
            ('Zaroxolyn', 'Metolazone', 'Fluid retention'),
            ('Mykrox', 'Metolazone', 'High blood pressure'),
            ('Midamor', 'Amiloride', 'Fluid retention'),
            ('Dyrenium', 'Triamterene', 'Fluid retention'),
            ('Maxzide', 'HCTZ/Triamterene', 'High blood pressure'),
            ('Dyazide', 'HCTZ/Triamterene', 'Hypertension'),
            ('Aldactazide', 'HCTZ/Spironolactone', 'High blood pressure'),
            ('Moduretic', 'HCTZ/Amiloride', 'Hypertension'),

            # Nausea and digestive expansion
            ('Zofran ODT', 'Ondansetron ODT', 'Nausea'),
            ('Zuplenz', 'Ondansetron oral film', 'Nausea'),
            ('Aloxi', 'Palonosetron', 'Chemotherapy nausea'),
            ('Anzemet', 'Dolasetron', 'Nausea'),
            ('Kytril', 'Granisetron', 'Nausea'),
            ('Sancuso', 'Granisetron patch', 'Nausea'),
            ('Emend', 'Aprepitant', 'Chemotherapy nausea'),
            ('Cinvanti', 'Aprepitant IV', 'Nausea'),
            ('Varubi', 'Rolapitant', 'Chemotherapy nausea'),
            ('Akynzeo', 'Netupitant/Palonosetron', 'Nausea'),
            ('Compro', 'Prochlorperazine suppository', 'Nausea'),
            ('Tigan', 'Trimethobenzamide', 'Nausea'),
            ('Cesamet', 'Nabilone', 'Chemotherapy nausea'),
            ('Marinol', 'Dronabinol', 'Nausea, appetite'),
            ('Syndros', 'Dronabinol liquid', 'Nausea'),
            ('Dramamine', 'Dimenhydrinate', 'Motion sickness'),
            ('Bonine', 'Meclizine', 'Motion sickness'),
            ('Marezine', 'Cyclizine', 'Motion sickness'),
            ('Emeset', 'Ondansetron', 'Nausea'),
